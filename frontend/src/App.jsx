...
import { LITE_PREDICT_ABI, DEFAULT_CONTRACT, DIA_LTC_USD, LITVM_RPC, LITVM_CHAIN_ID } from "./constants/contract";
import { INITIAL_NEWS_ITEMS } from "./constants/news";
import { INITIAL_CHAT } from "./constants/chat";
import { fmt4, fmtTime, shortAddr, randomBetween } from "./utils/format";
import { generateOrderbook, genCandles, calcRoundScore } from "./utils/market";
